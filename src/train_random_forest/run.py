...
def go(args):
    ...
    if os.path.exists("random_forest_dir"): # not needed --> using tempdir, but leaving it 
        shutil.rmtree("random_forest_dir")  ## for now.
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        save_path = os.path.join(temp_dir, "random_forest_dir")
    ...
    ######################################
        ...
        artifact.wait() # it's in a tempdir so make sure created prior to tempdir deletion.
